...
public:
  ...
  virtual ::android::binder::Status importWrappedKey(const ::std::string& alias, ::com::rdk::hal::cryptoengine::Algorithm algorithm, ::com::rdk::hal::cryptoengine::KeyType keyType, const ::std::vector<uint8_t>& wrappedKeyData, const ::std::string& wrappingKeyAlias, const ::com::rdk::hal::cryptoengine::CryptoConfig& unwrapParams, int32_t usages, bool extractable, ::com::rdk::hal::keyvault::KeyDescriptor* _aidl_return) = 0;
  virtual ::android::binder::Status exportKey(const ::std::string& alias, ::std::vector<uint8_t>* _aidl_return) = 0;
  virtual ::android::binder::Status exportWrappedKey(const ::std::string& alias, const ::std::string& wrappingKeyAlias, const ::com::rdk::hal::cryptoengine::CryptoConfig& wrapParams, ::std::vector<uint8_t>* _aidl_return) = 0;
