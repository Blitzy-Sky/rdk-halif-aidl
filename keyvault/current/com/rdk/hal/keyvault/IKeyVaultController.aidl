...
interface IKeyVaultController {
     ...
     * type, size, usages).
     *
     * Supports all derivation functions: HKDF, PBKDF2, DH, AUTHENTICATED_DH.
     * For AUTHENTICATED_DH, three output specs are expected (encryption, hmac, wrapping).
     ...
     * @param peerPublicKey Peer's public key for DH/AUTHENTICATED_DH. Null for HKDF/PBKDF2.
